...
<div id="page-wrapper">
          ...
          <div class="col-lg-12 ">
            ...
            <div class="col-md-3 col-lg-3">
                 <div class="[ form-group ]">
                    <input type="checkbox" name="subuh_jmh" id="subuh_jmh" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
                ...
                <div class="[ form-group ]">
                    <input type="checkbox" name="dzuhur_jmh" id="dzuhur_jmh" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
                ...
                <div class="[ form-group ]">
                    <input type="checkbox" name="ashar_jmh" id="ashar_jmh" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
                ...
                <div class="[ form-group ]">
                    <input type="checkbox" name="maghrib_jmh" id="maghrib_jmh" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
                ...
                <div class="[ form-group ]">
                    <input type="checkbox" name="isya_jmh" id="isya_jmh" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
            ...
            <div class="col-md-3 col-lg-3">
                <div class="[ form-group ]">
                   <input type="checkbox" name="tahajud" id="tahajud" autocomplete="off" value="1" />
                   <div class="[ btn-group ]">
               ...
               <div class="[ form-group ]">
                   <input type="checkbox" name="qobliyah_subuh" id="qobliyah_subuh" autocomplete="off" value="1" />
                   <div class="[ btn-group ]">
               ...
               <div class="[ form-group ]">
                   <input type="checkbox" name="qobliyah_dzuhur" id="qobliyah_dzuhur" autocomplete="off" value="1" />
                   <div class="[ btn-group ]">
           ...
           <div class="col-md-3 col-lg-3">
                <div class="[ form-group ]">
                    <input type="checkbox" name="badiyah_dzuhur" id="badiyah_dzuhur" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
                ...
                <div class="[ form-group ]">
                    <input type="checkbox" name="badiyah_maghrib" id="badiyah_maghrib" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
                ...
                <div class="[ form-group ]">
                    <input type="checkbox" name="badiyah_isya" id="badiyah_isya" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
                ...
                <div class="[ form-group ]">
                    <input type="checkbox" name="doa_ortu" id="doa_ortu" autocomplete="off" value="1" />
                    <div class="[ btn-group ]">
       ...
       <div class="col-md-3 col-lg-3">
            <div class="[ form-group ]">
                <input type="checkbox" name="doa_donatur" id="doa_donatur" autocomplete="off" value="1" />
                <div class="[ btn-group ]">
            ...
            <div class="[ form-group ]">
                <input type="checkbox" name="dzikir_pagi" id="dzikir_pagi" autocomplete="off" value="1" />
                <div class="[ btn-group ]">
            ...
            <div class="[ form-group ]">
                <input type="checkbox" name="dzikir_petang" id="dzikir_petang" autocomplete="off" value="1" />
                <div class="[ btn-group ]">
            ...
            <div class="[ form-group ]">
                <input type="checkbox" name="alkahfi" id="alkahfi" autocomplete="off" value="1" />
                <div class="[ btn-group ]">
        ...
        <div class="col-md-6 col-lg-6">
            <table class="table">
                <tbody>
                    <tr>
                        <td><label> Tilawah Al Quran</label></td>
                        <td><input class="form-control"  type="number"></td>
                    </tr>
                    <tr>
                        <td><label>Hafalan Ayat</label></td>
                        <td><input class="form-control"  type="number"></td>
                    </tr>
                </tbody>
            </table>
