...
@section('title')
Santri @if($divisi=='kka'){{"Kakak Asuh"}}@endif
@endsection
@section('content')
{{-- =================================================================== --}}
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">@if($divisi=='kka')<i>Kakak Asuh</i>@endif </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <p class="blue">Total @if($divisi=='kka')<i>Kakak Asuh</i>@endif <b class="red">{{$total}}</b></p>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        <td>
                                            ...
                                            @else
                                                <div class="form-group">
                                                    <img height="50" width="70" style="float: left; padding-left: 10px; padding-right: 10px;" src="{{asset('images/flower1.jpg')}}">
                                                </div>
                                            @endif
